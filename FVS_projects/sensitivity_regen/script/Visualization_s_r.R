...
ggsave('./Figure/sstv_regen/1_pools_ND.jpg',p_p,dpi=300,width = 6.2, height = 3.1, units="in")
...
pr
ggsave('./Figure/sstv_regen/2_growth_rate.jpg',pr,dpi=300,width = 6, height = 2.8, units="in")
...
ph
ggsave('./Figure/sstv_regen/3_H_index.jpg',ph,dpi=300,width = 6, height = 2.8, units="in")
...
ggsave('./Figure/sstv_regen/4_pools_D.jpg',p_p,dpi=300,width = 6, height = 4, units="in")
...
pr
ggsave('./Figure/sstv_regen/5_growth_rate_D.jpg',pr,dpi=300,width = 6, height = 3, units="in")
...
ph
ggsave('./Figure/sstv_regen/6_H_index_D.jpg',ph,dpi=300,width = 6, height = 6, units="in")
...
p_tc
# save 
ggsave('./Figure/sstv_regen/total_carbon.jpg',p_tc,dpi=300,width = 6, height = 3, units="in")

p_tc3 <- ggarrange(p_tc_ns,p_tc_ws,nrow=1,labels=c("E","F"),align = "h",
                   common.legend = TRUE, legend = "none") %>%
  annotate_figure(top = text_grob("Sensitivity - Regeneration"))
...
# save spp
ggsave('./Figure/sstv_regen/SI/spp_nd.jpg',p1,dpi=300,width = 5.5, height = 4.5, units="in") ; ggsave(
  './Figure/sstv_regen/SI/spp_ld.jpg',p2,dpi=300,width = 5.5, height = 4.5, units="in") ; ggsave(
    './Figure/sstv_regen/SI/spp_hd.jpg',p3,dpi=300,width = 5.5, height = 4.5, units="in")
# save dbh
ggsave('./Figure/sstv_regen/SI/dbh_nd.jpg',p1,dpi=300,width = 5.5, height = 4.5, units="in");ggsave(
  './Figure/sstv_regen/SI/dbh_ld.jpg',p2,dpi=300,width = 5.5, height = 4.5, units="in");ggsave(
    './Figure/sstv_regen/SI/dbh_hd.jpg',p3,dpi=300,width = 5.5, height = 4.5, units="in")
