...
# set project dir
setwd("/Users/weierliu/Dropbox (YSE)/YASSP/PROJECTS/DOE_Road to Removal/case_studies/new_england_forests/FVS_simulation/rFVS/FVSProjects/sensitivity_dist")
...
ggsave('./Figure/sstv_dist/4_pools_D.jpg',p_p,dpi=300,width = 6, height = 4, units="in")
...
pr
ggsave('./Figure/sstv_dist/5_growth_rate_D.jpg',pr,dpi=300,width = 6, height = 3, units="in")
...
ph
ggsave('./Figure/sstv_dist/6_H_index_D.jpg',ph,dpi=300,width = 6, height = 6, units="in")
...
p_tc
# save 
ggsave('./Figure/sstv_dist/total_carbon.jpg',p_tc,dpi=300,width = 6, height = 3, units="in")

p_tc2 <- ggarrange(p_tc_ns,p_tc_ws,nrow=1,labels=c("C","D"),align = "h",
                  common.legend = TRUE, legend = "none") %>%
  annotate_figure(top = text_grob("Sensitivity - Disturbance"))
################################################################################
...
# save spp
ggsave('./Figure/sstv_dist/SI/spp_ld.jpg',p2,dpi=300,width = 5.5, height = 4.5, units="in") ; ggsave(
    './Figure/SI/sstv_dist/spp_hd.jpg',p3,dpi=300,width = 5.5, height = 4.5, units="in")
# save dbh
ggsave('./Figure/SI/dbh_ld.jpg',p2,dpi=300,width = 5.5, height = 4.5, units="in");ggsave(
